...
main_picwidth: "25%"
main_findings:
  - "Most **rural** election jurisdictions **offer far less** to voters in terms on **online** tools. States and jurisdictions should **priortize** helping them provide more **access and information** to their voters."
...
There are many definitions of rural and little agreement across disciplines and government agencies on exactly what makes a location rural [@Waldorf:2015]. Given this issue, we fully expect that there may be some disagreement on whether specific counties are urban or rural. For our purposes we are using the Rural-Urbam continuum codes from the USDA ERS [@USDA:2013]. "The 2013 Rural-Urban Continuum Codes form a classification scheme that distinguishes metropolitan counties by the population size of their metro area, and nonmetropolitan counties by degree of urbanization and adjacency to a metro area." Counties are coded on 1-9 scale where one is the most urban and 9 is the most rural. Few reliable scales of rurality exist below the county level. This create particular challenges for election jurisdictions that operate at the sub-county level, but our plan will be to link these to the USDA's Rural-Urban Commuting Area (RUCA) codes [@Cromartie:2008]. The RUC codes are shown in the map below.
...
p <- items %>% 
  ...
  labs(x = "Rural-Urban Continuum Code", y = "Percent that Include", title = "Variation in Online Tools Across One Dimension of Rurality", caption = "Note: This includes only the 34 states coded thus far. Results are subject to change.") +
  theme_ipsum() + theme(strip.placement = "outside", plot.title = element_text(size = 32), plot.caption = element_text(size = 18), text = element_text(size=20))
p
